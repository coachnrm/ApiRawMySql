...
public partial class Nondrugitem
{
    ...
    public string? ExtIcode { get; set; }

    public string? ChargePaidst { get; set; }

    public string? Lockprint { get; set; }

    public string? RxUnique { get; set; }

    public string? ItemIsDf { get; set; }

    public int? DfTypeId { get; set; }
    ...
    public string? RemoveWhenAdmit { get; set; }
    ...
    public string? NoIpdTransfer { get; set; }

    public string? NoDiscount { get; set; }

    public string? DfSearchCode { get; set; }
    ...
    public string? HospitalHighcostCode { get; set; }

    public string? LockprintIpd { get; set; }

    public string? EnableSksOpd { get; set; }

    public string? EnableSksIpd { get; set; }
    ...
    public double? SksCoveragePrice { get; set; }
    ...
    public string? ObjctiveText { get; set; }
    ...
    public int? NondrugitemsTypeId { get; set; }

    public string? UcefCode { get; set; }

    public string? Lockprice { get; set; }

    public string? IsAccm { get; set; }
    ...
    public string? LockPttype { get; set; }

    public string? LockPttypeCode { get; set; }
    ...
    public int? SksClaimCategoryTypeId { get; set; }

    public string? NhsoProjectCode { get; set; }

    public string? SksTmltCode { get; set; }
